Spree::FrontendHelper.module_eval do
  def spree_breadcrumbs(taxon, product, separator = '&nbsp;')
    ...
    if taxon
      ...
      crumbs << content_tag(:li, content_tag(:span, link_to(content_tag(:span, taxon.name, itemprop: 'name'), seo_url(taxon), itemprop: 'url'), itemprop: 'item'), class: 'noactive', itemscope: 'itemscope', itemtype: 'https://schema.org/ListItem', itemprop: 'itemListElement')
